...
## Custom upload uncertainty

The browser offers custom image upload, but retained observations do not establish
its request, response, storage service, or `image.source` value. The `uploadPhoto`
contract facts remain unverified in this manuscript.
