...
numbers inside the browser. Contact phone numbers and email addresses are
private and must not be exposed. Prefix matches sort before other matches
without a documented secondary key. Past-guest, phone-contact, and follower
...
The separate operator-attended observation now establishes actual page lengths,
...
[Dated event and contact observation](events.md#scope-and-provenance).
